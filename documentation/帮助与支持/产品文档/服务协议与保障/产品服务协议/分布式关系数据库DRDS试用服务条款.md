...
**本试用服务条款是京东云网站所有者（本协议中称为“京东云”网址：**[www.jdcloud.com](http://www.jdcloud.com/)**）与您就分布式关系数据库DRDS相关事项所订立的有效合约。您通过盖章、网络页面点击确认或以其他方式选择接受本**试用**服务条款，包括但不限于未点击确认本**试用**服务条款而事实上使用了京东云**分布式关系数据库DRDS****试用**服务，即表示您与京东云已达成协议并同意接受本**试用**服务条款的全部约定内容。如若双方盖章文本与网络页面点击确认或以其他方式选择接受之服务条款文本，存有不一致之处，以双方盖章文本为准。**
...
1.1本条款中“服务”指：京东云向您提供[www.jdcloud.com](http://www.jdcloud.com/)网站上所展示的分布式关系数据库DRDS试用服务以及相关的技术及网络支持服务。
...
7.2.5 京东云可提前在[www.jdcloud.com](http://www.jdcloud.com/) 上通告或给您发网站内通知或书面通知的方式终止本服务条款。届时京东云应将您已支付但未消费的款项退还至您的京东云账户。
...
11.2 京东云有权以提前在[www.jdcloud.com](http://www.jdcloud.com/)上公布或给您发网站内通知或书面通知的方式将本服务条款的权利义务全部或者部分转移给京东云的关联公司。
